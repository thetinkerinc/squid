...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$EntryType ? _default.$EntryType : 
  T extends _default.$CurrencyType ? _default.$CurrencyType : 
  T extends _default.$AccountType ? _default.$AccountType : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _extauth.$FlowType ?
    ...
    never
  :
  A extends _default.$EntryType ?
    B extends _default.$EntryType ?
    B
    :
    never
  :
  A extends _default.$CurrencyType ?
    B extends _default.$CurrencyType ?
    B
    :
    never
  :
  A extends _default.$AccountType ?
    B extends _default.$AccountType ?
    B
    :
    never
  :
